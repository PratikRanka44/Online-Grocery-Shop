...
from groceryapp.views import ComingSoon, ComingSoon2, addToCart, admin_change_password, admin_order_track, booking, cart, change_order_status, contact, delete_feedback, delete_order, delete_user, deletecart, footer, home,incredecre, manage_feedback, manage_order, manage_user, myOrder,navigation,about,index,adminLogin,adminHome,admin_dashboard,add_category, navigation2, payment, read_feedback, user_feedback, user_order_track,view_category,edit_category,delete_category,add_product,view_product
from groceryapp.views import edit_product,delete_product,registration, userlogin, profile,logoutuser,change_password,user_product,product_detail, footer2
